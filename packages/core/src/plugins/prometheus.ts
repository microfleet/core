...
import { Microfleet, PluginTypes, RouterPlugin, ValidatorPlugin, PluginInterface } from '..'
 ...
 */
export function attach(this: Microfleet & RouterPlugin & ValidatorPlugin, opts: any = {}): PluginInterface {
