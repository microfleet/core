...
import * as Backoff from '@microfleet/transport-amqp/lib/utils/recovery'
// @todo import { AMQPPluginConfig } from '@microfleet/plugin-amqp' ?
import { AMQPPluginConfig } from '@microfleet/plugin-amqp/lib/types/plugin'
